...
$lang = array_merge($lang, array(
	...
	'PORTAL_NEWS_STYLE_EXP'			=> '"Ja" betekend dat je gebruik wilt maken van de compacte stijl. "Nee" betekend dat je gebruik wilt maken van de grote stijl (tekstweergave).',
	...
	'PORTAL_NEWS_PERMISSIONS_EXP'	=> 'Houd rekening met permissies voor het bekijken van forums bij het weergeven van nieuws',
	'PORTAL_NEWS_SHOW_LAST'				=> 'Sorteren op laatste berichten',
	'PORTAL_NEWS_SHOW_LAST_EXP'		=> ',Indien ingeschakeld, wordt het nieuws gesorteerd op laatste berichten. Indien uitgeschakeld, wordt het nieuws gesorteerd op het laatst geplaatste onderwerp.',
	...
	'PORTAL_SHOW_REPLIES_VIEWS'				=> 'Laat het aantal reacties en weergaven zien',
	'PORTAL_SHOW_REPLIES_VIEWS_EXP'		=> 'Deze instelling betreft het compacte blok.<br>Als "Ja" is ingesteld, wordt het aantal reacties en weergaven weergegeven in 2 extra kolommen. Als "Nee" is ingesteld, worden reacties en weergaven weergegeven naast de forumnaam. Selecteer Nee, als je problemen hebt met de weergave van de extra kolommen doordat er extra breedte nodig is.',
));
